# ADR: Choosing Talos OS for Homelab Setup
...
We chose Talos OS as the base operating system for the homelab Kubernetes cluster.
Rationale
...
- Security as a Priority
    - Talos OS is designed with a security-first approach:
        ...
        - Minimal userland and no package manager, reducing vulnerabilities.
